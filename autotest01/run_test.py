...
suite.addTest(loader.discover(r'D:\Tools\PythonWorkSpace\autotest01\testcases'))

# 2.4使用HTMLTestRunner运行测试案例，并且生成html类型的结果报告
with open(r'D:\Tools\PythonWorkSpace\autotest01\reports\report.html', 'wb') as fb:
